...
def log_security_event(db: Session, user_id: Optional[int], event_type: str, details: str, ip_address: str = "unknown"):
    """Log security events"""
    try:
...
def log_activity(db: Session, user_id: Optional[int], action: str, details: str, ip_address: str = "unknown"):
    """Log user activities"""
    try:
